...
_winningMessage = "Время истекло. Победа ВС КНДР!"; // Сообщение которое показывается по окончанию миссии

[_missionTime, _winningSide, _winningMessage] spawn ATRIUM_fnc_timeout;

// Параметры для завершения миссии по потерям
_bluforThreshold = 6; // минимальное количество живых синих юнитов
_bluforMessage = "КМП США понесли тяжелые потери и отступили!"; // сообщение если проиграли синие
...
_opforMessage = "ВС КНДР понесли тяжелые потери и сдались!"; // сообщение если проиграли красные
