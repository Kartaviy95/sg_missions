...
_veh addItemCargoGlobal ["rhs_mag_30Rnd_556x45_M855_Stanag",18];
...
_veh addItemCargoGlobal ["rhs_mag_100Rnd_556x45_M855A1_cmag",8];


_veh addItemCargoGlobal ["rhs_weap_M136",1];
_veh addItemCargoGlobal ["rhs_mag_100rnd_127x99_mag_Tracer_Red",6];