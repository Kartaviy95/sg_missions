...
_winningMessage = "Время истекло. CCO РФ успела передать данные!"; // Сообщение которое показывается по окончанию миссии
...
_bluforMessage = "Атака понесла тяжелые потери!"; // сообщение если проиграли синие
...
_opforMessage = "Оборона понесли тяжелые потери!"; // сообщение если проиграли красные
