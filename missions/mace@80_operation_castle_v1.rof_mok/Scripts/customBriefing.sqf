...
switch (side player) do {
	...
	// для зеленых
	case independent: {
		player createDiaryRecord ["diary", ["Задачи", loadFile "A3A_BRIEFING\briefing_IND_TASKS.html"]];
		player createDiaryRecord ["diary", ["Противник", loadFile "A3A_BRIEFING\briefing_IND_ENEMY.html"]];
	};
};
