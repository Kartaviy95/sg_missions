...
_cloud = "#particlesource" createVehicleLocal (position player);
...
{
	//drop particles
	_cloud setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal_02.p3d",8,0,40,1], "", "Billboard", 1, _lifetime, [0,0,_height], [0,0,0], 0.1, 9.996,7.84, 0, [_capSize], [_color,_colorTarget], [0.2,0.2], 10, 0.1, "", "", _object, random(360)/(2 * pi), false, -1.0, [_color,_colorTarget]];
