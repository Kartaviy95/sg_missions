...
[
	...
	"Завод ЧВК был захвачена!", // текст, который будет показан в нотификациях после захвата
...
_winningMessage = "Французы завладели заводом. Победа атаки!"; // сообщение, которое показывается при захвате требуемого количества зон
