...
_veh addItemcargoGlobal ['rhs_30Rnd_762x39mm_bakelite_tracer', 10];
...
_veh addItemcargoGlobal ['rhs_mag_rgo', 10];
_veh addItemcargoGlobal ['rhs_VOG25', 10];
_veh addItemcargoGlobal ['vtn_og7v', 5];
_veh addItemcargoGlobal ['mkk_10Rnd_762x54mmR_t46', 10];
...
_veh addItemcargoGlobal ["vtn_pg7v", 5];
