...
for "_i" from 1 to 2 do {_unit addItemToVest "rhssaf_100rnd_556x45_EPR_G36";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "rhssaf_100rnd_556x45_EPR_G36";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "rhssaf_30rnd_556x45_Tracers_G36";};
