...
_bluforThreshold = 3; // минимальное количество живых синих юнитов
_bluforMessage = "US Army понесла тяжелые потери и сдалась!"; // сообщение если проиграли синие
...
_opforMessage = "ВС РФ понесли тяжелые потери и отступили!"; // сообщение если проиграли красные
