...
_veh setVariable ["TF_RadioType", "tf_anprc155_coyote", true];

_veh addBackpackCargoGlobal ["tf_anprc155_coyote",1];
_veh addItemcargoglobal ["rhs_weap_M136_hedp", 1]; 
_veh addItemcargoglobal ["rhs_weap_M136", 1]; 
_veh addItemcargoglobal ["rhs_mag_30Rnd_556x45_M855A1_EPM", 20];
_veh addItemcargoglobal ["rhs_mag_30Rnd_556x45_M855A1_EPM_Tracer_Red", 10]; 
_veh addItemcargoglobal ["rhsusf_200Rnd_556x45_soft_pouch_ucp", 10];
_veh addItemcargoglobal ["mkk_20Rnd_M80A1_762x51_HK417_D", 15]; 
...
_veh addItemCargoGlobal ["mkk_mag_Rbs_56_OTA",2];			
_veh addItemCargoGlobal ["mkk_mag_Rbs_56",2];			
_veh addItemCargoGlobal ["mkk_mag_Rbs_56_BB",2];			
_veh addItemCargoGlobal ["rhs_mag_762x54mm_250",2];			
