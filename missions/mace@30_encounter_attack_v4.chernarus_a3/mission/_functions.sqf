...
fnc_deleteLocalAllMarkersOfName = 
{
	private["_i", "_j", "_t"];
...
fnc_deleteAllVehiclesOfName = 
{
	...
	while {_j < 100} do
	{
		...
		if (!isNil _t) then
		{
			deleteVehicle (missionNamespace getVariable _t);
			_j = 0;
		}
		else
		{
