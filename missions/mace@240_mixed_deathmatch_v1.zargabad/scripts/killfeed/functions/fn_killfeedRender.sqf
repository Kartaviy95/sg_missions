...
{
_renderKillerText = if (((_x select 0) == player) or ((_x select 0) == (vehicle player))) then {"<t color='#25DD00' font='PuristaMedium' size='1'>" + name (_x select 0) + "<t/>"} else {"<t color='#FF0000' font='PuristaMedium' size='1'>" + name (_x select 0) + "<t/>"};
_renderKilledText = if (((_x select 2) == player) or ((_x select 2) == (vehicle player))) then {"<t color='#25DD00' font='PuristaMedium' size='1'>" + name (_x select 2) + "<t/>"} else {"<t color='#FF0000' font='PuristaMedium' size='1'>" + name (_x select 2) + "<t/>"};
