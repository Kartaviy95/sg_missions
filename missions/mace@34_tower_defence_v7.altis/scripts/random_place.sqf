...
_x setpos [(_coords select 0) + (sin _dir*_step),(_coords select 1) + (cos _dir*_step)];
...
_red_win setTriggerStatements ["((WEST countSide thislist) < 1) and ((EAST countSide thislist) > 0)", "['Боевики зачистили военную базу', EAST] call a3a_fnc_endMission",""];
...
//instructor_menu = player addaction [("<t color=""#FF0000"">Random</t>"),"random_place.sqf",[false],20,false,true,"","(_target distance _this) < 0.00001"];
