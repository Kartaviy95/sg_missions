...
_veh addItemCargoGlobal ["ACE_morphine", 18];
_veh addItemCargoGlobal ["ACE_epinephrine", 18]; 
...
_veh addItemcargoglobal ["rhs_30Rnd_545x39_7N22_AK", 35];
...
_veh addItemcargoglobal ["mkk_B8_Binocular", 1];

_veh addItemcargoglobal ["rhs_GRD40_White", 10];
_veh addItemcargoglobal ["rhs_100Rnd_762x54mmR_7N13", 13]; 
