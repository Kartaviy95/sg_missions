...
_bluforMessage = "Армия США понесли тяжелые потери и сдались!"; // сообщение если проиграли синие
...
_opforMessage = "Армия Ирана понесла тяжелые потери и отступила!"; // сообщение если проиграли красные
