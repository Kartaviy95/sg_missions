...
if (!isDedicated) then
{
 ...
 [ 
 [ 
  ["Лингор, ", "<t align = 'right' shadow = '1' size = '0.7' >%1</t>"], 
  ["осень 2026 года", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],
  ["Добро пожаловать в джунгли!", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],  
  ["","<br/>"], // line break
  ["Solidnye meicy", "<t align = 'right' shadow = '1' size = '1.0'font='PuristaBold'>%1</t>", 15] 
 ] 
