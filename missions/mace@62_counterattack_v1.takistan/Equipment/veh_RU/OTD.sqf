...
_veh addWeaponCargoGlobal ["rhs_weap_rsp30_white",20];
_veh addMagazineCargoGlobal ["rhs_mag_nspn_red", 10];
_veh addMagazineCargoGlobal ["rhs_mag_nspn_green", 10];
_veh addMagazineCargoGlobal ["rhs_mag_nspn_yellow", 10];
_veh addItemCargoGlobal ["rhs_VG40OP_green",10];
_veh addItemCargoGlobal ["rhs_VG40OP_white",10];
_veh addItemCargoGlobal ["rhs_VG40OP_red",10];
