...
for "_i" from 1 to 5 do {this addItemToVest "rhs_30Rnd_545x39_7N10_desert_AK";};
for "_i" from 1 to 2 do {this addItemToVest "rhs_30Rnd_545x39_AK_green";};
for "_i" from 1 to 4 do {this addItemToVest "rhs_GDM40";};
this addBackpack "B_Kitbag_tan";
for "_i" from 1 to 2 do {this addItemToBackpack "rhs_30Rnd_545x39_AK_green";};
for "_i" from 1 to 2 do {this addItemToBackpack "rhs_mag_rgd5";};
for "_i" from 1 to 2 do {this addItemToBackpack "rhs_mag_rdg2_black";};
for "_i" from 1 to 14 do {this addItemToBackpack "rhs_VOG25";};
this addHeadgear "rhsgref_ssh68_ttsko_dark";
