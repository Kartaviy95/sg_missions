...
_veh addItemCargoGlobal ["vtn_mroa",2];
_veh addItemCargoGlobal ["nmg_30Rnd_545x39_7N10_AK12",16];
_veh addItemCargoGlobal ["rhs_30Rnd_545x39_AK_plum_green",8];
_veh addItemCargoGlobal ["rhs_100Rnd_762x54mmR_7N13",4];
...
_veh addbackpackcargoglobal ["rhs_assault_umbts_engineer_empty",2];
