...
_veh addItemcargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red",4];
_veh addItemCargoGlobal ["rhs_mag_m67",6];
_veh addItemCargoGlobal ["rhs_mag_an_m8hc",6];
_veh addItemCargoGlobal ["rhsusf_mich_bare_norotos",4];
_veh addItemCargoGlobal ["ToolKit",2];
_veh addbackpackcargoglobal ["B_Kitbag_rgr",4];

_veh addItemCargoGlobal ["ACE_rope6",2];
_veh addItemCargoGlobal ["ACE_rope12",2];

_veh addItemCargoGlobal ["rhs_mag_M829A3",20];
_veh addItemCargoGlobal ["rhs_mag_M830A1",8];
_veh addItemCargoGlobal ["rhs_mag_M1069",12];
