...
_veh addItemcargoGlobal ["SLAMDirectionalMine_Wire_Mag",6];
_veh addItemcargoGlobal ["rhs_mine_pmn2_mag",6];
_veh addItemcargoGlobal ["APERSBoundingMine_Range_Mag",4];
_veh addItemcargoGlobal ["APERSTripMine_Wire_Mag",6];
_veh addItemcargoGlobal ["rhsusf_m112x4_mag",4];
_veh addItemcargoGlobal ["ACE_M26_Clacker",8];