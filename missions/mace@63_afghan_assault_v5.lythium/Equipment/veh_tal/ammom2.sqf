...
_veh addItemcargoglobal ["rhs_30Rnd_545x39_7N6_AK", 15]; 
...
_veh addBackpackCargoGlobal ["rhsgref_hidf_alicepack", 2];

_veh addItemcargoglobal ["rhs_rpg7_OG7V_mag", 5];
_veh addItemcargoglobal ["rhs_rpg7_PG7VL_mag", 5];

_veh addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
_veh addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
_veh addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
_veh addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
_veh addMagazineTurret ["100Rnd_127x99_mag_Tracer_Yellow",[0]];
