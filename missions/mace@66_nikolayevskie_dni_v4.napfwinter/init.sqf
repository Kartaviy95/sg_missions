...
if (!isDedicated) then
{
 ...
 [ 
 [ 
  ["Россия, ", "<t align = 'right' shadow = '1' size = '0.7' >%1</t>"], 
  ["Дальневосточная республика", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],
  ["","<br/>"], // line break
  ["Николаевск-на-Амуре", "<t align = 'right' shadow = '1' size = '1.3'>%1</t><br/>"],  
  ["","<br/>"], // line break
