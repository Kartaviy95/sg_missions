...
_winningMessage = "Иракским войскам прибыло подкрепление. Победа обороны!"; // Сообщение которое показывается по окончанию миссии
...
_bluforMessage = "Иракская армия понесла тяжёлые потери. Победа НВФ!"; // сообщение если проиграли синие
...
_independentThreshold = 4; // минимальное количество живых зеленых юнитов
_independentMessage = "НВФ понесли тяжелые потери. Победа Иракской армии!"; // сообщение если проиграли зеленые
