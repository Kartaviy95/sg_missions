...
_unit addWeapon "pzn_slot_rhs_weap_m32";
_unit addSecondaryWeaponItem "pzn_slot_muzzle_base";
_unit addSecondaryWeaponItem "RH_peq15b_top";
...
for "_i" from 1 to 3 do {this addItemToBackpack "rhsusf_mag_6Rnd_M441_HE";};
