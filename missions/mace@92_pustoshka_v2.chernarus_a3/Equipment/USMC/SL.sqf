...
_unit addWeapon (random_USMC_sl_m16 select (floor (random (count random_USMC_sl_m16))));
...
_unit addPrimaryWeaponItem (random_USMC_recon_rco select (floor (random (count random_USMC_recon_rco))));
