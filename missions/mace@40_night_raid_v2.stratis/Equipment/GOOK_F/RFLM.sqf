...
for "_i" from 1 to 10 do {this addItemToVest "mkk_sks_mag";};
for "_i" from 1 to 5 do {this addItemToVest "mkk_sks_mag_t";};
...
for "_i" from 1 to 5 do {this addItemToBackpack "mkk_sks_mag";};
this addHeadgear "rhsgref_hat_M1951";

this addWeapon "mkk_sks";
