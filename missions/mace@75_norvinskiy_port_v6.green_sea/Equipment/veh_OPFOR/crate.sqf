_veh = _this select 0;
_veh addBackpackCargoGlobal ["rhs_assault_umbts", 5];
...
_veh addItemCargoGlobal ["rhs_60Rnd_545X39_7N22_AK",25];
_veh addItemCargoGlobal ["mkk_30rnd_9x39_sr3m_sp6",10];
_veh addItemCargoGlobal ["rhs_10Rnd_762x54mmR_7N14",10];
_veh addItemCargoGlobal ["mkk_VTN_RPK74_45p_AP",10];
