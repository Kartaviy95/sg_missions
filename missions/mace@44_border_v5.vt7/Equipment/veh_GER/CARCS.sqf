...
_veh addItemCargoGlobal ["mkk_hlc_20rnd_762x51_b_G3",20];
_veh addItemcargoGlobal ["mkk_hlc_20rnd_762x51_T_G3", 10];
_veh addItemCargoGlobal ["BWA3_DM51A1",7];
_veh addItemCargoGlobal ["BWA3_DM53",7];
_veh addItemCargoGlobal ["mkk_pzf3_tandem",1];
_veh addItemCargoGlobal ["BWA3_PzF3",1];
