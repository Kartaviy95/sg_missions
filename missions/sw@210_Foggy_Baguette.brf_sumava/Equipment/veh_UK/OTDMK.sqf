...
_veh addItemCargoGlobal ["BWA3_RGW90MP_Loaded",1];
...
_veh addItemCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG",24];
_veh addItemcargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red",8];
_veh addItemcargoGlobal ["mkk_20Rnd_M61_762x51_HK417",8];
_veh addItemcargoGlobal ["rhsusf_100Rnd_762x51_m80a1epr",8];
_veh addItemcargoGlobal ["rhs_mag_M441_HE",24];
