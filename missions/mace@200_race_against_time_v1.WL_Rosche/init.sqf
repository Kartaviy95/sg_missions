...
if (!isDedicated) then
{
 ...
 [ 
 [ 
  ["Где-то на нейтральной полосе...", "<t align = 'right' shadow = '1' size = '0.7' >%1</t>"], 
  ["1944 год...", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],
  ["Гонка со временем...", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],  
  ["","<br/>"], // line break
