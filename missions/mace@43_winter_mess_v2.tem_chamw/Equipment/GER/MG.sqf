...
_unit addItem "mkk_hlc_50Rnd_762x51_B_MG3";
...
for '_i' from 1 to 5 do { _unit addItemToVest 'mkk_hlc_50Rnd_762x51_B_MG3';};

// Backpack with items:
_unit addBackpack "BWA3_AssaultPack_Fleck";
_unit addItemToBackpack  'mkk_hlc_50Rnd_762x51_B_MG3';
