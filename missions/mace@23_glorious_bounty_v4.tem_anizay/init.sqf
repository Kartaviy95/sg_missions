...
if (!isDedicated) then
{
 ...
 [ 
 [ 
  ["20 миль к западу от Дейр-Хафир, Сирия. ", "<t align = 'ight'r shadow = '1' size = '0.7' >%1</t><br/>"],
...
call {cutText ["<t color='#00bfff'size='1.4'>Мы будем сражаться на пляжах, мы будем сражаться на посадочных площадках,<br/>
 мы будем сражаться на полях и на улицах, мы будем сражаться на холмах;<br/>
мы никогда не сдадимся.</t>", "PLAIN DOWN", 1,4, true, true];}