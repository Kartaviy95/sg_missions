...
_veh addItemcargoglobal ["rhsgref_5Rnd_792x57_kar98k", 30]; 
_veh addItemcargoglobal ["mkk_32rnd_9x19_mp40", 8]; 
_veh addItemcargoglobal ["fow_e_nb39b", 4]; 
_veh addItemcargoglobal ["fow_e_m24", 8]; 
