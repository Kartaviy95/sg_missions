...
_unit addPrimaryWeaponItem "LIB_1Rnd_G_PZGR_40";
...
for '_i' from 1 to 3 do { _unit addItemToVest 'LIB_1Rnd_G_PZGR_40';};
...
for "_i" from 1 to 4 do {_unit addItemToBackpack "LIB_1Rnd_G_PZGR_40";};
