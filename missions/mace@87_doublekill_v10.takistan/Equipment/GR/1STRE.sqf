...
for "_i" from 1 to 2 do {this addItemToVest "rhs_30Rnd_762x39mm_bakelite";};
this addItemToVest "rhs_mag_m67";
for "_i" from 1 to 6 do {this addItemToBackpack "rhs_30Rnd_762x39mm_bakelite";};
for "_i" from 1 to 2 do {this addItemToBackpack "rhs_30Rnd_762x39mm_bakelite_tracer";};
this addItemToBackpack "rhs_mag_m67";
for "_i" from 1 to 3 do {this addItemToBackpack "rhs_mag_f1";};
