#define __markersRed 	["one_tp", "two_tp", "three_tp", "four_tp", "five_tp", "six_tp", "seven_tp"]    									//массив маркеров доступных для выбора КС красных
...
#define __selectorEnd 	[5176.548, 8047.713]    							//позиция завершения выбора x,y
...
if (_ks && {isNil '_marker'}) exitWith {
	...
	["Выберите место появления отделения разведки. Доступно 7 вариантов."] call bn_selector_create_group;
