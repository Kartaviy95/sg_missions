...
_veh addItemCargoGlobal ["BWA3_DM51A1",12];
...
_veh addItemCargoGlobal ["BWA3_10Rnd_762x51_G28_LR",12];
_veh addItemCargoGlobal ["rhs_mag_M441_H",15];
_veh addBackpackCargoGlobal ["BWA3_FieldPack_Fleck",3];
