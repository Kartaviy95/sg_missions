...
_veh addItemCargoGlobal ["mkk_hlc_rifle_saiga12k",1];
_veh addItemCargoGlobal ["mkk_hlc_10rnd_12g_buck_S12",6];
_veh addItemCargoGlobal ["rhs_mag_rgd5",20];
_veh addItemCargoGlobal ["rhs_mag_rdg2_white",20];
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_polymer",25];
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_polymer_tracer",12];
...
_veh addItemCargoGlobal ["rhs_fieldcap_digi2",2];
