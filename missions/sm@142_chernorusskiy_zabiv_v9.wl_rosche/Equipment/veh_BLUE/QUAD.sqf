...
_veh addItemCargoGlobal ["rhs_mag_rdg2_black",4];
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_89",3];
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_bakelite_tracer",2];
