...
if (!isDedicated) then
{
 ...
 [ 
 [ 
  ["Остров Крит, ", "<t align = 'right' shadow = '1' size = '0.7' >%1</t>"], 
  ["1941 год", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],
  ["Операция Меркурий", "<t align = 'right' shadow = '1' size = '0.7'>%1</t><br/>"],  
  ["","<br/>"], // line break
