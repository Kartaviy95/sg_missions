...
_veh addItemcargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan_Tracer_Red", 15];
_veh addItemCargoGlobal ["rhs_mag_m67",6];
_veh addItemCargoGlobal ["SmokeShellPurple",6];
_veh addItemCargoGlobal ["rhs_mag_M441_HE",7];
_veh addItemCargoGlobal ["rhs_mag_M433_HEDP",7];
