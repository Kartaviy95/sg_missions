...
{},{hint "Идет опознание..."},{["Ликвидация цели подтверждена. Победа Националистов.", east] call a3a_fnc_endMission;},{hint "Опознание прервано."},
[],20,0,true,false]	call BIS_fnc_holdActionAdd;