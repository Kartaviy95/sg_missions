...
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_89",12];
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_tracer",6];
_veh addItemCargoGlobal ["rhsusf_100Rnd_762x51_m61_ap",6];

_veh addMagazinecargoglobal ["ace_48Rnd_40mm_MK19_M430A1", 10];
