...
//while { !isNil {paramsArray select 6} } do { sleep 0.1; };
//while { !isNil {paramsArray select 7} } do { sleep 0.1; };

sleep 1;
execvm "Custom_EQUIPMENT\uniform.sqf";
sleep 1;
execvm "Custom_EQUIPMENT\weapons.sqf";
