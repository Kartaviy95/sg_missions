...
_veh addItemcargoglobal ["rhs_30Rnd_545x39_AK_plum_green", 25];  
...
_veh addItemcargoglobal ["ace_mag_127x108mm_50", 15];

_veh addItemcargoglobal ["rhs_weap_rsp30_green", 10];
