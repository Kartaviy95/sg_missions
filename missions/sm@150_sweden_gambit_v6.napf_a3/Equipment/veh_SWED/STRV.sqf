...
_veh addItemCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag_Pull",10];
...
_veh addItemCargoGlobal ["mkk_mag_slpprj_m95_APFSDS",16];
...
_veh addItemcargoglobal ["mkk_helmet_lwh_M90_2", 4];