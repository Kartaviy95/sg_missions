...
for "_i" from 1 to 6 do {[_veh, "rhs_mag_b8m1_s8kom"] call ace_rearm_fnc_addMagazineToSupply;};
for "_i" from 1 to 6 do {[_veh, "rhs_mag_b8m1_s8t"] call ace_rearm_fnc_addMagazineToSupply;};
