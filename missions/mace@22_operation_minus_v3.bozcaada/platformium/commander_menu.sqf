#define __markersRed 	[]    									//массив маркеров доступных для выбора КС красных
#define __markersBlue 	["one_tp", "two_tp", "three_tp", "four_tp", "five_tp"]    	//массив маркеров доступных для выбора КС синих
#define __markersGreen 	[]    									//массив маркеров доступных для выбора КС зелёных

#define __selectorEnd 	[11400, 14100]    							//позиция завершения выбора x,y
