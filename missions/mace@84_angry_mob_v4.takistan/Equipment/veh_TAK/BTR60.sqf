...
_veh addItemCargoGlobal ["rhs_30Rnd_762x39mm_89_tracer",10];
_veh addItemCargoGlobal ["rhs_VOG25",20];
_veh addItemCargoGlobal ["ToolKit",1];
_veh addItemCargoGlobal ["LOP_H_SSh68Helmet_TAN",2];


_veh addBackpackCargoGlobal ["rhssaf_kitbag_md2camo", 2];