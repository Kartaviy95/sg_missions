...
_veh addItemCargoGlobal ["rhsusf_mich_helmet_marpatwd",2];
_veh addItemCargoGlobal ["rhsusf_cvc_green_helmet",1];
...
_veh addItemcargoglobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag_No_Tracer", 30];
