...
_veh addItemCargoGlobal ["pzn_f1",5];
...
_veh addWeaponCargoGlobal ["rhs_weap_rsp30_red",15];
_veh addWeaponCargoGlobal ["rhs_weap_rsp30_green",15];
_veh addMagazineCargoGlobal ["Chemlight_green", 5];
_veh addMagazineCargoGlobal ["Chemlight_red", 5];
_veh addMagazineCargoGlobal ["Chemlight_blue", 5];
...
_veh addItemCargoGlobal ["rhs_GDM40",15];