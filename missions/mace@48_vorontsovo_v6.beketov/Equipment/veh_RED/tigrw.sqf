...
_veh addItemcargoglobal ["ACE_morphine", 88];


_veh addItemcargoglobal ["mkk_hlc_30Rnd_9x19_B_MP5", 20];
_veh addItemcargoglobal ["rhsusf_5Rnd_00Buck", 10];
_veh addItemcargoglobal ["rhsusf_mag_40Rnd_46x30_FMJ", 20];
_veh addItemcargoglobal ["rhs_mag_30Rnd_556x45_M855_Stanag", 20];
_veh addItemcargoglobal ["mkk_VTN_RPK74_45p_AP", 20];