...
//v2.0 (requires arma 2.06)

if (isNil "VLS_LAUNCHER") then { VLS_LAUNCHER = VLS; };
if (isNil "VLS_USERS") then { VLS_USERS = [ks]; };
...
private _condition="(alive VLS_LAUNCHER)&&(player in VLS_CURRENT_USERS)";
...
player addAction [VLS_MENU_TXT, _vls_main,nil,1.5,false,true,"",_condition];	
